...
A traditional software version cycle begins with the development phase, where bugs are expected and ironed out, and ends with the production phase, which promises a seamless user experience. R-releases aims at a space just before production, commonly referred to as QA, in that:
